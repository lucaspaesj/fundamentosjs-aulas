...
class Tela {
    static obterCodigoHtml(item) {
        return `
        <div class="col-nd-3">
            <div class="card" style="width: 8%;" onclick="window.verificarSelecao('${item.id}', '${item.nome}')">
    ...
    static exibirHerois(nomeDoHeroi, img){
        ...
        // para cada elemnto encontrado na tela, vamos alterar a imagem
    ...
    static iniciarContador(){
        ...
        // onde está o $$contador adicinaremos o valor
