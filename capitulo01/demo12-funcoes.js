function nomeDaFuncao(parametro1){ // declarando a função e estabelecendo seus parâmetros e o bloco de código
    // bloco de código
}
...
const idade = 20
const tamanho = 10
const resultado = soma(idade, tamanho) // REPARAR QUE AQUI A CONS FOI CRIADA NO ESCOPO GLOBAL
console.log("Resultado:", resultado)

function multiplicar(valor1, valor2){
    const resultado = valor1 * valor2 // AQUI, FOI CRIADA A VARIAVEL NO CONTEXTO LOCAL, ENTÃO ELA NASCE E MORRE AQUI
    return resultado
}
...
console.log(`Salário ${funcionario1.nome}: ${funcionario1.salarioLiquido}
